...
public class LoadTableDynamoDB_CmcSurveyQuestionsAutismDisorder
{	 
	private static Logger logger = LogManager.getLogger(LoadTableDynamoDB_CmcSurveyQuestionsAutismDisorder.class);
	...
	public static void loadTable(DynamoClients dynamoClients) throws Exception 
	{
        ...
        String jsonFilePath = "C:\\Paul\\GitHub\\CMC\\src\\main\\resources\\data\\" + SURVEYQUESTIONS_AUTISM_DISORDER_JSONFILE;
