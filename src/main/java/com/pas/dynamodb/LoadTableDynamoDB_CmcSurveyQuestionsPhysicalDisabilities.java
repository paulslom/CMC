...
public class LoadTableDynamoDB_CmcSurveyQuestionsPhysicalDisabilities
{	 
	private static Logger logger = LogManager.getLogger(LoadTableDynamoDB_CmcSurveyQuestionsPhysicalDisabilities.class);
	...
	public static void loadTable(DynamoClients dynamoClients) throws Exception 
	{
        ...
        String jsonFilePath = "C:\\Paul\\GitHub\\CMC\\src\\main\\resources\\data\\" + SURVEYQUESTIONS_PHYSICAL_DISABILITIES_JSONFILE;
